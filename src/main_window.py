...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.clip_start_spin.setFixedWidth(self.clip_start_spin.fontMetrics().horizontalAdvance("0000") + 18)
        ...
        clip_row.addWidget(self.new_clip_btn, stretch=0)
        ...
        self.cine_loop_label = QLabel("Cine loop label:")
        label_row.addWidget(self.cine_loop_label, stretch=0)
    ...
    def _build_sidebar(self):
        ...
        video_actions_row.addWidget(self.video_btn)
        self.clear_video_btn = QPushButton("Clear video(s)")
        configure_button(self.clear_video_btn)
        video_actions_row.addWidget(self.clear_video_btn)
        layout.addLayout(video_actions_row)
        ...
        layout.addSpacing(6)
        sep_models_end = QFrame()
        sep_models_end.setFrameShape(QFrame.Shape.HLine)
        sep_models_end.setFrameShadow(QFrame.Shadow.Sunken)
        layout.addWidget(sep_models_end)
